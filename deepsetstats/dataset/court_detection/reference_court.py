...
class CourtReference:
    ...
    def __init__(self):
        ...
        self.ref_points = [
            ...
            self.baseline_bottom[0],
            self.left_inner_line[1],
            self.mid_point(self.left_inner_line[1], self.right_inner_line[1]),
            ...
            self.mid_point(self.left_inner_line[0], self.right_inner_line[0]),
    ...
    def build_court_reference(self):
        ...
        cv2.line(court, *self.baseline_top, white_color, self.line_width)
        cv2.line(court, *self.baseline_bottom, white_color, self.line_width)
        cv2.line(court, *self.net, white_color, self.line_width)
        cv2.line(court, *self.top_inner_line, white_color, self.line_width)
        cv2.line(court, *self.bottom_inner_line, white_color, self.line_width)
        cv2.line(court, *self.left_court_line, white_color, self.line_width)
        cv2.line(court, *self.right_court_line, white_color, self.line_width)
        cv2.line(court, *self.left_inner_line, white_color, self.line_width)
        cv2.line(court, *self.right_inner_line, white_color, self.line_width)
        cv2.line(court, *self.middle_line, white_color, self.line_width)
